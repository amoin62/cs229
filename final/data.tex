...
\centering
\begin{tabular}{cc}
\subfloat[Word cloud for positive comments \label{fig:poscloud}]{\includegraphics[width=0.95\columnwidth]{figures/pos_WordCloud.png}} & 
\subfloat[Word cloud for negative comments \label{fig:negcloud}]{\includegraphics[width=0.95\columnwidth]{figures/neg_WordCloud.png}}
\end{tabular}
